export default function PuzzleGrid({ grid, getCellColor, onCellClick, interactive = false, glowGreen = false, glowYellow = false, glowWhite = false, glowBlue = false, glowDarkBlue = false, puzzleNumber = null }) {
  return (
